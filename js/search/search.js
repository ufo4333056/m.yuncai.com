(function (window) { 
    ...
    search.bindClickEvent = function () {
        ...
        a_mix.on('click',function(){
            ...
            var _newUrl = replaceUrlParams(myURL, {order: 0, page: parseInt(page.val())});
        ...
        a_order_sale.on("click", function () {
            ...
            var my_sale = parseInt($(this).attr("data-id"));
            if (my_sale == 1) {
                var _newUrl = replaceUrlParams(myURL, {order: 2, page: parseInt(page.val())});
                location.href = _newUrl;
            }
            else {
                var _newUrl = replaceUrlParams(myURL, {order: 1, page: parseInt(page.val())});
                location.href = _newUrl;
            }
        ...
        a_price_sale.on("click", function () {
            ...
            var my_sale = parseInt($(this).attr("data-id"));
            if (my_sale == 4) {
                var _newUrl = replaceUrlParams(myURL, {order: 3, page: parseInt(page.val())});
                location.href = _newUrl;
            }
            else {
                var _newUrl = replaceUrlParams(myURL, {order: 4, page: parseInt(page.val())});
                location.href = _newUrl;
            }
        });
        //上架时间
        a_release_time.on("click", function () {
            ...
            var my_sale = parseInt($(this).attr("data-id"));
            if (my_sale == 5) {
                var _newUrl = replaceUrlParams(myURL, {order: 6, page: parseInt(page.val())});
                location.href = _newUrl;
            }
            else {
                var _newUrl = replaceUrlParams(myURL, {order: 5, page: parseInt(page.val())});
                location.href = _newUrl;
            }
        });
        //评论数
        a_review_count.on("click", function () {
            ...
            var my_sale = parseInt($(this).attr("data-id"));
            if (my_sale == 7) {
                var _newUrl = replaceUrlParams(myURL, {order: 8, page: parseInt(page.val())});
                location.href = _newUrl;
            }
            else {
                var _newUrl = replaceUrlParams(myURL, {order: 7, page: parseInt(page.val())});
                location.href = _newUrl;
            }
        });
